import { QuestTypeEnum, StatusEnum, RarityEnum, RewardsItemEnum } from "../Enums"
...
const QuestsFile = [
  ...
  {
    title: {
      "English": "MSc Développeur Jeu Vidéo, rendu 3D temps réel et technologies immersives & Mastère Européen Expert IT",
      "Français": "MSc Développeur Jeu Vidéo, rendu 3D temps réel et technologies immersives & Mastère Européen Expert IT"
    },
    ...
    rewards: [
      ...
      },
      {
        name: {
          ...
          "Français": "[Compétence] Leadership & Soft Skills"
        },
  ...
  {
    title: {
      "English": "Bachelor Développeur Informatique, option Jeu Vidéo",
      "Français": "Bachelor Développeur Informatique, option Jeu Vidéo"
    },
    QuestType: QuestTypeEnum.MAIN,
  ...
  // Volunteer QA/Tester Appearance
  {
    title: {
