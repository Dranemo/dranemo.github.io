...
import '../componentCSS/Achievements2.css';
  ...
  return (
    <div className='Card' id='CardAch'>
        ...
        <Project 
            ...
            details={PortfolioProject.details}
          />
          ...
          <Project 
            ...
            details={PathfindingSimulationProject.details}
          />
          ...
          <Project 
            ...
            details={BranCastleProject.details}
          />
          ...
          <Project 
            ...
            details={BuildToScaleProject.details}
          />
          ...
          <Project 
            ...
            details={FoxLeagueProject.details}
          />
          <Project 
            ...
            details={PokemonRedBlueCSharpProject.details}
          />
          <Project 
            ...
            details={ZoryaSistersProject.details}
          />
          <Project 
            ...
            details={GameOfLifeCProject.details}
          />
        </div>
    </div>
  );
